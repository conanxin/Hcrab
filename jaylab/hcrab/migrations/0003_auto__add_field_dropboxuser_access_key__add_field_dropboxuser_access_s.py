...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DropboxUser.access_key'
        db.add_column(u'hcrab_dropboxuser', 'access_key',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'DropboxUser.access_secret'
        db.add_column(u'hcrab_dropboxuser', 'access_secret',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding unique constraint on 'DropboxUser', fields ['uid']
        db.create_unique(u'hcrab_dropboxuser', ['uid'])


    def backwards(self, orm):
        # Removing unique constraint on 'DropboxUser', fields ['uid']
        db.delete_unique(u'hcrab_dropboxuser', ['uid'])

        # Deleting field 'DropboxUser.access_key'
        db.delete_column(u'hcrab_dropboxuser', 'access_key')

        # Deleting field 'DropboxUser.access_secret'
        db.delete_column(u'hcrab_dropboxuser', 'access_secret')
