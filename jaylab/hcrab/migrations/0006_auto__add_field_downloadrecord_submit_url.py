...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DownloadRecord.submit_url'
        db.add_column(u'hcrab_downloadrecord', 'submit_url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=400, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DownloadRecord.submit_url'
        db.delete_column(u'hcrab_downloadrecord', 'submit_url')
