...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DropboxUser.created_at'
        db.add_column(u'hcrab_dropboxuser', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DropboxUser.created_at'
        db.delete_column(u'hcrab_dropboxuser', 'created_at')
