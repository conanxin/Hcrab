...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VideoFile.latest_ref'
        db.add_column(u'hcrab_videofile', 'latest_ref',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VideoFile.latest_ref'
        db.delete_column(u'hcrab_videofile', 'latest_ref')
    ...
    models = {
        ...
        u'hcrab.videofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'latest_ref': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
